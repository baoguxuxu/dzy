...
@Controller
@RequestMapping("/reward/userTitle")
public class UserTitleController {
	...
	String UserTitle(){
	    return "reward/userTitle/userTitle";
	}
	...
	public R updateEnable(Integer id,Integer enable) {
		UserTitleDO ut = new UserTitleDO();
		ut.setId(id);
		ut.setStatus(enable);
		userTitleService.update(ut);
		return R.ok();
	}

...
@RequestMapping("/information/usersdetail")
public class UserDetailController {
	...
	String User(){
	    return "information/usersdetail/user";
	}
	...
	String add(){
	    return "information/usersdetail/add";
	}
	...
	String edit(@PathVariable("id") Integer id,Model model){
	    ...
	    return "information/usersdetail/edit";
	}
	...
	String show(@PathVariable("id") Integer id,Model model){
		UserDO user = userService.get(id);
		model.addAttribute("user", user);
	    return "information/usersdetail/show";
	}
	/**
	 * 保存
	 */
	...
	@GetMapping("/treeView")
	String treeView() {
		return   "information/usersdetail/userTree";
	}
}

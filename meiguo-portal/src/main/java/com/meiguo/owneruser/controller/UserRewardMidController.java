...
@Controller
@RequestMapping("/information/userRewardMid")
public class UserRewardMidController {
	...
	String UserRewardMid(){
	    return "information/userRewardMid/userRewardMid";
	}
	...
	String add(){
	    return "information/userRewardMid/add";
	}
	...
	String edit(@PathVariable("id") Integer id,Model model){
	    ...
	    return "information/userRewardMid/edit";
	}
